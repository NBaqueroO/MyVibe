        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="space-y-8">
            ...
            <h1 className="font-heading text-4xl font-bold leading-tight tracking-tight sm:text-5xl lg:text-6xl">
              Tu música{" "}
              <span className="text-primary">define quién eres.</span>
            </h1>

            <p className="max-w-md text-muted-foreground leading-relaxed">
              Crea tu perfil dinámico basado en tus gustos reales de Spotify y conecta con personas que vibran en tu misma sintonía.
            </p>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-muted-foreground">+12k amantes de la música ya se han unido</span>
            </div>
          </div>
          ...
          <div className="relative mx-auto w-full max-w-sm">
            <div className="rounded-2xl border border-border bg-card p-6 shadow-lg" style={{ boxShadow: "var(--glow-primary)" }}>
              ...
              <div className="mt-6">
                <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Top Artistas</p>
              ...
              <div className="mt-6">
                <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Género Predominante</p>
                <div className="mt-3">
              ...
              <div className="mt-5 flex items-center gap-3 rounded-lg bg-secondary px-4 py-3">
                ...
                <div>
                  <p className="text-xs text-muted-foreground">Escuchando ahora</p>
